...
impl ErrorCode {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ErrorCode::EnvVarWriteOnly => "ENV_VAR_WRITE_ONLY",
            ...
            ErrorCode::SecretRevealRequired => "SECRET_REVEAL_REQUIRED",
    ...
    pub fn from_api(s: &str) -> Self {
        match s {
            ...
            "ENV_VAR_WRITE_ONLY" => ErrorCode::EnvVarWriteOnly,
