...
impl ErrorCode {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ErrorCode::ArchiveTooLarge => "ARCHIVE_TOO_LARGE",
            ...
            ErrorCode::FlooignoreReadFailed => "FLOOIGNORE_READ_FAILED",
    ...
    pub fn from_api(s: &str) -> Self {
        match s {
            ...
            "ARCHIVE_ERROR" => ErrorCode::ArchiveError,
            "ARCHIVE_TOO_LARGE" => ErrorCode::ArchiveTooLarge,
            ...
            "FLOOIGNORE_READ_FAILED" => ErrorCode::FlooignoreReadFailed,
