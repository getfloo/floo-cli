...
impl ErrorCode {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ErrorCode::ContainerRuntimeUnavailable => "CONTAINER_RUNTIME_UNAVAILABLE",
            ErrorCode::CwdError => "CWD_ERROR",
            ErrorCode::DatabaseNotFound => "DATABASE_NOT_FOUND",
            ErrorCode::DeployFailed => "DEPLOY_FAILED",
            ErrorCode::DockerfileMissing => "DOCKERFILE_MISSING",
    ...
    pub fn from_api(s: &str) -> Self {
        match s {
            ...
            "CONTAINER_BUILD_FAILED" => ErrorCode::ContainerBuildFailed,
            "CONTAINER_RUNTIME_UNAVAILABLE" => ErrorCode::ContainerRuntimeUnavailable,
            "CWD_ERROR" => ErrorCode::CwdError,
            "DATABASE_NOT_FOUND" => ErrorCode::DatabaseNotFound,
            "DEPLOY_FAILED" => ErrorCode::DeployFailed,
            "DOCKERFILE_MISSING" => ErrorCode::DockerfileMissing,
